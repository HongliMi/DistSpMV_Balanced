...
//         }
    ...
    */
    ...
    if (id == 0)
    {
        ...
        writeresults("./csv/DistSpMV_Balanced.csv", filename, sourcematrix.rownum, sourcematrix.colnum, sourcematrix.nnznum,sdrc_time,time, sdrc_time+time, GFlops, p, nthreads);
