	...
	*/
    ...
    for (int r = 0; r < NTIMES; r++)
    {
        ...
        if (id == 0) 
        {
            ...
            if(ttime<comtime)  comtime=ttime;
...
*/
    ...
    if (id == 0)
    {
        ...
        writeresults("./csv/DistSpMV.csv", filename, sourcematrix.rownum, sourcematrix.colnum, sourcematrix.nnznum,comtime,distime, distime+comtime, GFlops, p, nthreads);
    }
