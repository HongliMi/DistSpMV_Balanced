...
data = pd.read_csv('../csv/DistSpMV_com.csv')
...
heatmap.set_title("DistSpMV_road_central",fontsize=15)
figure = heatmap.get_figure()
figure.savefig('../figure/DistSpMV_road_central_heatmap.jpg')  # 保存图片
plt.show()
...
# heatmap = sns.heatmap(uniform_data,vmin=0,vmax=500,annot=True,fmt="d",cmap="YlGnBu",cbar=False,xticklabels=x,yticklabels=x) # 生成热力图
heatmap = sns.heatmap(uniform_data,vmin=0,vmax=500,annot=True,fmt="d",cmap="YlGnBu",xticklabels=x,yticklabels=x) # 生成热力图
heatmap.set_title("DistSpMV_inline_1",fontsize=15)
figure = heatmap.get_figure()
figure.savefig('../figure/DistSpMV_inline_1_heatmap.jpg')  # 保存图片
plt.show()
