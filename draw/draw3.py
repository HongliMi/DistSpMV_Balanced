...
data = pd.read_csv('../csv/DistSpMV_Balanced_com.csv')
...
heatmap.set_title("DistSpMV_Balanced_road_central",fontsize=15)
figure = heatmap.get_figure()
figure.savefig('../figure/DistSpMV_Balanced_road_central_heatmap.jpg')  # 保存图片
plt.show()
...
figure = heatmap.get_figure()
figure.savefig('../figure/DistSpMV_Balanced_inline_1_heatmap.jpg')  # 保存图片
plt.show()